...
import { Download, Pencil, Plus, SquareArrowOutUpRight, Trash2 } from 'lucide-react';
...
const ConversationRow = observer(function ConversationRow({
  ...
  } = useTabSelection(tabKind, conversationId);
          ...
          <div className="flex shrink-0 items-center gap-1">
            {conversation.indicatorStatus ? (
              ...
              <RelativeTime
                ...
                className="flex h-full items-center pr-1 font-sans text-xs text-foreground-passive group-hover:hidden"
                compact
              />
            )}
            {!isEditing && (
